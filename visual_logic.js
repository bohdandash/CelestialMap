...
handleAnnot(true, '1', 'Moon', 'cluster fucking moon', 'poi1', undefined);

registerOnClick('Moon', false, false, [0,1,2], function() {
  console.log('From Moon to Camera:');
  console.log(getDistanceBetweenObjects('Moon', 'Camera.001'));
}, function() {});
...
if (getGPU('MODEL').indexOf('GeForce GTX') >= 0) {
  setScreenScale(3);
}
